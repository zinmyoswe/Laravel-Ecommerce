...
<div class="container">
            ...
            <div class="blog">
                <h2 style="font-size: 28px; text-align: center;">TOP PICKS FOR YOU</h2>
  <br>
    ...
    border-bottom: 1px solid transparent;"></li>
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active" style="height: 20rem;">
                                <div class="row">
                                            @foreach($top_pick as $product)

                                    <div class="col-sm-3 col-xs-6">
                                        <a href="{{ route('shop.show', $product->slug) }}">
                                            <img src="{{ productImage($product->image) }}" alt="Image" style="width: 200px; height:200px;" class="img-responsive">
